...
export default function cliente(){
    return(
        <section className="h-full w-full flex flex-col items-center mt-10">
            <div className="h-[40px] mb-[50px]">
                <h1 className="text-3xl ">Productos</h1>
            </div>
            <div className="w-full h-full m-auto px-[70px] grid grid-cols-3 grid-rows-1 gap-9 text-lg justify-center">
                <Link href='\cliente\crearTicket\Olvide mi contraseña'>
                    <article className="w-full rounded-md shadow-lg p-8 hover:bg-slate-300 text-center flex flex-col justify-center h-[350px]">
